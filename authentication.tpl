...
{if !isset($email_create)}
	<form action="{$base_dir_ssl}authentication.php" method="post" id="create-account_form" class="std">
		<fieldset>
			...
			<p class="text">{l s='Enter your e-mail address to create your account'}.</p>
			<p>
			...
			{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
				<input type="submit" id="SubmitCreate" name="SubmitCreate" class="button" value="{l s='Sign up'}" />
...
<form action="{$base_dir_ssl}authentication.php" method="post" id="account-creation_form" class="std">
	...
	<fieldset class="account_creation">
		...
		<p class="required" id="address_alias">
