...
{/if}
	...
	<body>
		<div id="maintenance">
			 ...
			 <p id="message">
				<img src="{$img_dir}maintenance.gif" alt="maintenance" />{l s='In order to perform site maintenance, our online shop has been taken offline temporarily. We apologize for the inconvenience, and ask that you please try again later !'}
			 </p>
